...
import great_expectations as gx  # type: ignore # noqa: F401
...
from great_expectations_provider.operators.great_expectations import (  # type: ignore
...
############################# START OF EXERCISE 1 #############################
    ...
    data_quality_task = GreatExpectationsOperator(
        ...
        expectation_suite_name=f"de-c2w4a1-expectation-suite",  # noqa: F541
    ...
    def train_and_evaluate(bucket_name: str, vendor_name: str):
        ...
        train = pd.read_parquet(f"{Variable.get("bucket_name")}/{vendor_name}/train.parquet")
        test = pd.read_parquet(f"{Variable.get("bucket_name")}/{vendor_name}/test.parquet")
