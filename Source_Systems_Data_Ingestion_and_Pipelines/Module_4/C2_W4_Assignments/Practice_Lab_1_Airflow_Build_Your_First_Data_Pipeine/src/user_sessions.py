...
RAW_DATA_BUCKET = "de-c2w4lab1-217008311733-us-east-1-raw-data"
### END CODE HERE ###
...
with DAG(
    ...
    def get_new_users(**context):
        ...
        response = requests.get(
            f"http://174.129.152.230:8000/users?start_date={start_date}&end_date={end_date}"
        )
        ### END CODE HERE ###
    ...
    def get_session(**context):
        ...
        # APIEndpoint to fill the `<API_ENDPOINT>` placeholder.
        response = requests.get(
            f"http://174.129.152.230:8000/sessions?start_date={start_date}&end_date={end_date}"
        )
        ### END CODE HERE ###
    ...
    def save_complete_session(**context):
        ...
        logger.info(f"Saving file: {complete_sessions_file_name}")
        ### START CODE HERE ### (5 lines of code)
        # Call the `put_object` method of the boto3 client by passing the
        ...
        logger.info(f"File: {complete_sessions_file_name} saved")
